...
class PokemonsActivity : AppCompatActivity() {
    ...
    fun bindData(pokemons: List<Pokemon>) {
        ...
        findViewById<TextView>(R.id.pokemon_order_2).text =
            "order - " + pokemons[1].order.toString()
        ...
        findViewById<TextView>(R.id.pokemon_order_3).text =
            "order - " + pokemons[2].order.toString()
        ...
        findViewById<TextView>(R.id.pokemon_order_4).text =
            "order - " + pokemons[3].order.toString()
        ...
        findViewById<TextView>(R.id.pokemon_order_5).text =
            "order - " + pokemons[4].order.toString()
        ...
        findViewById<TextView>(R.id.pokemon_order_6).text =
            "order - " + pokemons[5].order.toString()
        ...
        findViewById<TextView>(R.id.pokemon_order_7).text =
            "order - " + pokemons[6].order.toString()
        ...
        findViewById<TextView>(R.id.pokemon_order_8).text =
            "order - " + pokemons[7].order.toString()
        ...
        findViewById<TextView>(R.id.pokemon_order_9).text =
            "order - " + pokemons[8].order.toString()
        ...
        findViewById<TextView>(R.id.pokemon_order_10).text =
            "order - " + pokemons[9].order.toString()
